  ...
  template:
    ...
    spec:
      ...
      - name: zk-web-docker
        ...
        - name: ZKWEB_PORT
          value: "8080"
        - name: ZKWEB_DEFAULT_NODE
          value: "zookeeper-headless.zookeeper-space.svc.cluster.local:2181"
        - name: ZKWEB_CREDENTIALS
          value: "admin:qwe123asd"
---
apiVersion: v1
kind: Service
metadata:
...
* 端口转发
```sh
$ kubectl port-forward --address 0.0.0.0 --namespace zookeeper-space service/zk-web-docker 12345:8080
```